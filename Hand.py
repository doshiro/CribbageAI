...
class Hand:
    ...
    def showCards( self, num ):
        ...
        #Loop to iterate through cards in hand
        for x in range( 0, num ):
            # print the index and card at index
            print( str(x) + " - " + self.cardString( self.cardNums[x] ) )
    ...
    def score(self, cut, checkCrib):
        ...
        if not checkCrib:
            ...
            if ( self.cardVals[1][1] == suit and self.cardVals[2][1] == suit and self.cardVals[3][1] == suit ):
                print( "4-card flush in the hand for 4!" )
                points += 4

                #check for 5 card flush
                if( self.cardVals[4][1] == suit ):
                    print( "And the cut for 1 more!" )
                points += 1
            ...
            if( self.cardVals[1][1] == suit and self.cardVals[2][1] == suit and self.cardVals[3][1] == suit and self.cardVals[4][1] == suit ):
                print( "5 card flush in crib for 5!" )
                points += 5
        ...
        print( "This hand earned " + str(points) + " points!" )
        return points
